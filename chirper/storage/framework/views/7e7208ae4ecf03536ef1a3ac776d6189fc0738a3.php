                ...
                <div class="p-6 flex space-x-2">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center">
                            <div>
                                <span class="text-gray-800"><?php echo e($accommodation->user->name); ?></span>
                                <small class="ml-2 text-sm text-gray-600"><?php echo e($accommodation->created_at->format('j M Y, g:i a')); ?></small>
                                <?php if (! ($accommodation->created_at->eq($accommodation->updated_at))): ?>
...
<?php endif; ?>
                        ...
                        <p class="mt-4 text-lg text-gray-900"><?php echo e($booking->message); ?></p>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\test-site\resources\views/accommodation/index.blade.php ENDPATH**/ ?>